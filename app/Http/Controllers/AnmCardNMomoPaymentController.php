...
use App\AnmCardNMomoPayment;
use Illuminate\Http\Request;
use Validator, Input, Redirect, Response, JWTAuth,JWTFactory ; 
use App\User;
use DB;

class AnmCardNMomoPaymentController extends Controller
{
    /**
    ...
    public function anmCardNMomoPayment(Request $request){
     ...
     *
     * @param  \App\AnmCardNMomoPayment  $anmCardNMomoPayment
     * @return \Illuminate\Http\Response
     */
    public function show(AnmCardNMomoPayment $anmCardNMomoPayment)
    {
        //
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(AnmCardNMomoPayment $anmCardNMomoPayment)
    {
        //
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(Request $request, AnmCardNMomoPayment $anmCardNMomoPayment)
    {
        //
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function destroy(AnmCardNMomoPayment $anmCardNMomoPayment)
    {
        //
    }
}
